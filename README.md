...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/alexcote1/oh-my-zsh/master/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/alexcote1/oh-my-zsh/master/install.sh -O -)"
```
